...
carrega_catalogo($a_catalogo,$a_campos);

$_SESSION['catalogo'] = $a_catalogo;
...
function inclui_principal_publicacoes($a_catalogo)
{
  ...
  echo '<div class="container" style="margin: 0 auto;line-height: 1.5em;font-size: 0.90em">';
...
function carrega_catalogo(&$a_catalogo,$a_campos)
{
...
function exibe_catalogo($a_catalogo)
{
  ...
  foreach ($a_catalogo as $line_num => $line)
  {
    ...
    if(trim($line["disponível"]) == "sim")
    {
      ...
      $arquivo="./capas/".rtrim($line["imagem"]);
      ...
      echo '<img src="./capas/'.$capa.'" style="width:85%; display: block;  margin-top:20px;margin-left: 0;  margin-right: 0">';
      echo '</div>';

      echo '<div class="col s12 m8 l9">';
      echo '<p style="color:blue;font-size:1.2rem; margin:1rem 0rem 0;text-transform: uppercase;">' . $line["Título"] . '</p>';
      echo '<p style="color:#666666;margin:1rem 0rem 0;line-height:1rem;">' . ucwords(strtolower($line["Autor"])) . '</p>';
      echo '<p style="color:#666666;margin:1rem 0rem 0;line-height:1rem;">' . $line["Páginas"] . ' paginas</p>';
      echo '<p style="color:#666666;margin:1rem 0rem 0;line-height:1rem;">Publicado em ' . $line["Data de publicação"] . '</p>';
      echo '<p style="color:#666666;margin:1rem 0rem 0;line-height:1rem;">R$ ' . $line["preço"] . '</p>';
      echo '<p style="color:#666666;margin:1rem 0rem 0;line-height:1rem;"><a  href="detalhes.php?isbn='.$line["ISBN"].'">Detalhes...</a></p>';
